INSERT INTO beer (uuid, sort, type, image, content)
VALUES ('9ed339f3-743c-4b7a-8140-d89a48bb4214', 'Эль', 'Пшеничное пиво',
        ...
        'Пшеничное пиво (белое пиво, вайцен, вайсбир, нем. Weizenbier, Weissbier, нидерл. Witbier) — это пиво верхового брожения, которое варится с большой долей пшеницы по отношению к количеству ячменного солода. Два основных сорта — немецкий Weizenbier и бельгийский Witbier.
...
VALUES ('01fe25f0-1fde-450e-8e57-7c4f4ed56270', 'Лагер', 'Бокбир',
        ...
        'Бокбир (нем. Bockbier, Starkbier), сокращённо бок (Bock) — разновидность немецкого крепкого пива исключительно низового брожения с экстрактивностью начального сусла более 16 % и крепостью 6,3-7,2 %. В основном тëмное, за исключением майбока.
...
VALUES ('df926e00-5e1f-4ca0-90bc-3908765664f7', 'Смешанное', 'Ламбик',
        ...
        'Ламби́к — это обобщенное название семейства сортов пива, которое варят в регионе Пайоттенланд в Бельгии к юго-западу от Брюсселя и в самом Брюсселе с XIII века. Популярными сортами ламбика являются гёз  (англ.)рус., крик и фрамбуаз.
...
VALUES ('b75488bd-8889-43cc-849b-e5ac45fd2219', 'Смешанное', 'Бьер-де-Гард',
        ...
        'Бьер-де-Гард (фр. Bière de Garde, букв. «пиво для хранения») — традиционный региональный сорт французского пива, производящийся пивоварнями региона Нор-Па-де-Кале на севере Франции. Учитывая географическую близость к Бельгии, сорт подобен бельгийскому сезонному, однако отличается сладким солодовым вкусом.
